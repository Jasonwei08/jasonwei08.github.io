...
C: Given $$N$$, a number, and $$P$$, a probability that each element in the $$N$$ numbers is positive, $$T$$, the number of tests. Each test, you need to find all positives in the $$N$$ number in $$Q$$ queries on average when $$N=1000$$. <img width="151" alt="image" src="https://github.com/user-attachments/assets/a2f7d10b-2770-4582-a61a-91eeb84835e2">
